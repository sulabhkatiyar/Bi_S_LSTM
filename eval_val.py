...
def evaluate(loader, encoder, decoder, criterion, word_map, device):
    ...
    for i, (image, caps, caplens, allcaps, image_name) in enumerate(
        ...
        while True:
            ...
            ha, ca = decoder.decode_step1a(h, (ha, ca))  
            h1, c1 = decoder.decode_step2(torch.cat([ha, img_f], dim = 1),(h1, c1))  
            ...
            ha, ca = ha[prev_word_inds[incomplete_inds]], ca[prev_word_inds[incomplete_inds]]
        ...
        hra, cra = torch.zeros_like(img_r), torch.zeros_like(img_r)
        ...
        while True:
            ...
            hra, cra = decoder.decode_step_reverse1a(hr, (hra, cra))  
            hr1, cr1 = decoder.decode_step_reverse2(torch.cat([hra, img_r], dim = 1),(hr1, cr1))
            ...
            hra, cra = hra[prev_word_inds_r[incomplete_inds_r]], cra[prev_word_inds_r[incomplete_inds_r]]
